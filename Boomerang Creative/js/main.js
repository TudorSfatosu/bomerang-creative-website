...
$(function () {
	...
	const links = document.querySelectorAll(".hover-nav a");
	const colors = ["#F39608"];
	...
	for (let i = 0; i < links.length; i++) {
		...
		links[i].addEventListener("mouseleave", mouseexitFunc);
	}

	function resizeFunc() {
		const active = document.querySelector(".hover-nav li.hover-active");
